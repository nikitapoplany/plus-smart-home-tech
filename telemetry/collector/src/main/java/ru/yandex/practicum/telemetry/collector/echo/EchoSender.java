package ru.yandex.practicum.telemetry.collector.echo;
...
@ConditionalOnProperty(value = "echo.enabled", havingValue = "true")
@Service
public class EchoSender {
    ...
    public void echo() {
        ...
        EchoResponse echoResponse = echoService.echo(
            EchoRequest.newBuilder().setMessage("ping").build()
        );
